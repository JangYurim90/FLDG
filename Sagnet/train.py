#cd D:/DomainGeneralization/Sagnet
#python train.py --sources Rest --targets art_painting --method sagnet --sagnet --batch-size 32 -g 0
#pytorch==1.8.0 torchvision==0.9.0 torchaudio==0.8.0 cudatoolkit=11.1 -c pytorch -c conda-forge
